...
describe('user reducer', () => {
    ...
    it('should return the state after GET_CURRENT_USER_SUCCESS', () => {
        expect(user(undefined, {
            type: userConstants.GET_CURRENT_USER_SUCCESS, user: { username: 'username' }
        })).toEqual({
    ...
    it('should return the state after GET_CURRENT_USER_FAILURE', () => {
        expect(user({
            ...
            type: userConstants.GET_CURRENT_USER_FAILURE, error: mockError
        })).toEqual({
            error: mockError,
            loadingUser: false,
            loadedUser: false,
    ...
    it('should return the state after CHECK_USER_AVAIBILITY_SUCCESS', () => {
        expect(user(undefined, {
            type: userConstants.CHECK_USER_AVAIBILITY_SUCCESS, response: mockResponse
        })).toEqual({
    ...
    it('should return the state after CHECK_USER_AVAIBILITY_FAILURE', () => {
        expect(user(undefined, {
            type: userConstants.CHECK_EMAIL_AVAIBILITY_FAILURE, error: mockError
        })).toEqual({
            checkingEmail: false,
            error: mockError
        })
    ...
    it('should return the state after CHECK_EMAIL_AVAIBILITY_SUCCESS', () => {
        expect(user(undefined, {
            type: userConstants.CHECK_EMAIL_AVAIBILITY_SUCCESS, response: mockResponse
        })).toEqual({
            checkingEmail: false,
            checkedEmail: true,
